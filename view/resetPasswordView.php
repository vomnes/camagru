...
<h2 style="text-align: center;font-size: 1.7em;">Forgot your password ?</h2>
  <form action="" method="POST">
    <fieldset>
      <label for="name">Enter your <u>username</u><br>a reset password link<br>will be sent to your<br>email address<br><br></label><input type="text" name="username" maxlength="64" required><br>
    </fieldset>
